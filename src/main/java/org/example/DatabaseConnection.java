...
public class DatabaseConnection {
    public static Connection connect() { // creating connection with the database
        try {
            Class.forName("org.postgresql.Driver");
            String dbURL = "jdbc:postgresql://localhost:5432/"; // Write the name given to the database to be able to connect
            String username = ""; // Write database username to be able to connect
            String pwd = ""; // Write database password to be able to connect
    ...
    public static void handleSQLException(SQLException ex, Statement statement) { // function that handles sql exceptions and if there's an exception it will roll back
        System.out.println("SQL Exception: " + ex.getMessage());
        try {
            if (statement != null) {
